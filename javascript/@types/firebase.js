 ...
 * @property {function(string): Promise<any[]>} getAll - Fetches all documents from the given collection.
 * @property {function(string): Promise<any>} get - Fetches document with the specified document ID from the given collection.
